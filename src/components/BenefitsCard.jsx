  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-[#0b3d64] to-[#1a9bb9] rounded-3xl p-6 md:p-8 text-white shadow-2xl"
      >
        ...
        <div className="space-y-4">
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                <div className={`shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br ${benefit.color} flex items-center justify-center shadow-lg`}>
      ...
      >
        ...
        <div className="space-y-4">
          {hiringSteps.map((step, index) => (
            ...
            >
              <div className="shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-[#0b3d64] to-[#1a9bb9] flex items-center justify-center text-white font-bold text-sm mt-0.5">
                {index + 1}
              </div>

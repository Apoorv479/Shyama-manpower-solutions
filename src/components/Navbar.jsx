      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex py-4 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:gap-2">
            ...
            <Link
              to="/contact"
              className="rounded-lg bg-[#1a9bb9] px-5 py-2.5 text-[17px] font-medium text-white shadow-lg transition-all hover:bg-[#15849b] hover:shadow-xl focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-[#1a9bb9] ml-2"
            >
              Get Quote
            </Link>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-md p-2 text-[#0b3d64] transition-colors hover:bg-[#1a9bb9]/10 focus-visible:outline  focus-visible:outline-offset-2 focus-visible:outline-[#1a9bb9] md:hidden"
